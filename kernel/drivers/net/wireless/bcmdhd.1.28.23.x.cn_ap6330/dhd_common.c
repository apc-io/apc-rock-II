...
//add by toron, diffenert can use its own nvram.txt.
#define BCMDHD_AP6330_NVRAM_PATH "/system/etc/firmware/nvram_ap6330.txt"
...
dhd_common_init(osl_t *osh)
{
	...
	bcm_strncpy_s(nv_path, sizeof(nv_path), BCMDHD_AP6330_NVRAM_PATH, MOD_PARAM_PATHLEN-1);
