...
unsigned short ov5640_config_720p[]={
0x4201,0x01,0x3503,0x00,0x3406,0x00,0x3035,0x21,0x3036,0x70,0x3C07,0x08,
0x3820,0x47,0x3821,0x01,0x3814,0x31,0x3815,0x31,0x3800,0x00,0x3801,0x00,
0x3802,0x00,0x3803,0xF4,0x3804,0x0a,0x3805,0x3f,0x3806,0x06,0x3807,0xab,
0x3808,0x05,0x3809,0x00,0x380A,0x02,0x380B,0xd0,0x380C,0x07,0x380D,0x68,
0x380E,0x03,0x380F,0xD8,0x3813,0x06,0x3618,0x00,0x3612,0x29,0x3708,0x62,
0x3709,0x52,0x370C,0x03,0x3A0E,0x03,0x3A0D,0x04,0x4004,0x02,0x4713,0x03,
0x4407,0x04,0x460B,0x35,0x460C,0x22,0x3824,0x02,0x5001,0xA3,0x3008,0x02,
0x3821,0x00,0x3002,0x1c,0x3006,0xc3,0x4713,0x02,0x4407,0x0c,0x460b,0x35,
0x460c,0x20,0x3824,0x01,0x3003,0x03,0x3003,0x00,0x4003,0x81,0x4003,0x08,
0x4201,0x00,0x4202,0x01,
};
...
unsigned short ov5640_1280_720[]={	

	0x3103, 0x11, 0x3008, 0x82, 0x3008, 0x42, 0x3103, 0x03, 0x3017, 0xFF,
	0x3018, 0xFF, 0x3034, 0x18, 0x3035, 0x21, 0x3036, 0x70, 0x3037, 0x13,
	0x3108, 0x01, 0x3630, 0x2E, 0x3632, 0xE2, 0x3633, 0x23, 0x3621, 0xE0,
	0x3704, 0xA0, 0x3703, 0x5A, 0x3715, 0x78, 0x3717, 0x01, 0x370B, 0x60,
	0x3705, 0x1A, 0x3905, 0x02, 0x3906, 0x10, 0x3901, 0x0A, 0x3731, 0x12,
	0x3600, 0x08, 0x3601, 0x33, 0x302D, 0x60, 0x3620, 0x52, 0x371B, 0x20,
...
int cmos_config_ov5640(cmos_init_arg_t  *init_arg)
{
    ...
    }else if(init_arg->width == 1280) {
    	printk("cmos_config_ov5640() 720p\n");
		
    	array_size = sizeof(ov5640_config_720p)/2;
        array_addr = ov5640_config_720p;		
...
int cmos_init_ov5640(cmos_init_arg_t  *init_arg)
{
    ...
    if( (init_arg->width == 320) && (init_arg->height == 240) ) {
        ...
        array_size = sizeof(ov5640_1280_720)/2;
        array_addr = ov5640_1280_720;

        printk(" ov5640_1280_720 sizeof(ov5640_1280_720) %d \n",sizeof(ov5640_1280_720));
