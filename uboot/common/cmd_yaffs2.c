...
extern void cmd_yaffs_start(int start);
extern void cmd_yaffs_size(int size);
...
{
    char *mtpoint = argv[1];
    int start = (int)simple_strtoul(argv[2], NULL, 16);
    int size = (int)simple_strtoul(argv[3], NULL, 16);
    cmd_yaffs_start(start);
    cmd_yaffs_size(size);
