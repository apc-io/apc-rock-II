...
int vout_config(unsigned int mask,vout_info_t *info,struct fb_videomode *vmode);
...
#ifndef CONFIG_VPOST
int vout_find_match_mode(int fbnum,struct fb_videomode *vmode,int match);
#endif
...
struct fb_videomode *vout_get_video_mode(int vout_num,struct fb_videomode *vmode,int option);
