...
const unsigned int vpp_csc_parm[VPP_CSC_MAX][7] = {
    // C1,C2        C3,C4       C5,C6       C7,C8       C9,I        J,K      b0:YC2RGB,b8:clamp
...
const struct fb_videomode vpp_videomode[] = {
	...
	{ NULL, 60, 800, 600, KHZ2PICOS(40000), 88, 40, 23, 1, 128, 4,
	  FB_SYNC_VERT_HIGH_ACT+FB_SYNC_HOR_HIGH_ACT, FB_VMODE_NONINTERLACED, FB_MODE_IS_VESA},
#if 0
	/* 800x600@60 CVT */
	...
	{ NULL, 60, 1360, 768, KHZ2PICOS(85500), 256, 64, 18, 3, 112, 6,
	  FB_SYNC_VERT_HIGH_ACT+FB_SYNC_HOR_HIGH_ACT, FB_VMODE_NONINTERLACED, 0},
	/* 1366x768@60 */
...
EXTERN int vpp_irqproc_work(vpp_int_t type,int (*func)(void *argc),void *arg,int wait_ms,int work_cnt);
...
EXTERN void vpp_irqproc_del_work(vpp_int_t type,int (*func)(void *argc));
...
EXTERN void vpp_show_timing(char *str,struct fb_videomode *vmode,vpp_clock_t *clk);
