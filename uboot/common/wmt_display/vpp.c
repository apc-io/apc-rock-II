...
#ifdef CONFIG_VPP_STREAM_BLOCK
	if (wait_event_interruptible(vpp_mb_event,
...
{
	govrh_mod_t *govr = (govrh_mod_t *) arg;

	govr->mb_sync_cnt++;
	if ((govr->mb_sync_cnt % 2) == 0) {
