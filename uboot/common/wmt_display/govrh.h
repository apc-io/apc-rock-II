...
EXTERN void govrh_set_videomode(govrh_mod_t *base,struct fb_videomode *vmode);
EXTERN void govrh_get_tg(govrh_mod_t *base,vpp_clock_t * tmr);
EXTERN void govrh_get_videomode(govrh_mod_t *base,struct fb_videomode *vmode);
